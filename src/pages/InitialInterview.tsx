...
const InitialInterview = () => {
  ...
  const handleViewCandidate = (candidateId: number) => {
    navigate(`/dashboard/resume-details?id=${candidateId}&fromInitialInterview=true`);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Initial Interview</h1>
            <p className="text-gray-600 mt-1">Review and manage initial interview candidates</p>
          </div>
