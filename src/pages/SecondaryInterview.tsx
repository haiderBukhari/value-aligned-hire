...
const SecondaryInterview = () => {
  ...
  const applications = [
    {
      ...
      reason: "Advanced to technical round",
    ...
    },
    {
      ...
      location: "Denver, CO",
      experience: "5 years",
      skills: ["Strategy Planning", "Team Leadership", "Market Analysis"],
      reason: "Excellent leadership potential",
      dateRequested: "03/06/2024",
      action: "Review",
  ...
  const handleViewCandidate = (candidateId: number) => {
    navigate(`/dashboard/resume-details?id=${candidateId}&fromSecondaryInterview=true`);
  };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Secondary Interview</h1>
            <p className="text-gray-600 mt-1">Advanced technical and behavioral assessments</p>
          </div>
                      ...
                      <TableCell className="py-4">
                        <div className="flex items-center space-x-3">
                          <Avatar className="h-10 w-10 ring-2 ring-gray-100">
                            <AvatarFallback className="bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold text-sm">
